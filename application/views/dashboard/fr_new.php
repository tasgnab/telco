  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="fr_no">No. FR <span class="required">*</span></label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input id="fr_no" class="form-control col-md-7 col-xs-12" name="fr_no" required="required" type="text" data-inputmask="'mask': 'FR-9999999'">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="fr_date">FR Date <span class="required">*</span></label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <fieldset>
                            <input type="text" class="form-control has-feedback-left" id="fr_date" name="fr_date" aria-describedby="inputSuccess2Status2">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="fr_total">Total FR <span class="required">*</span></label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input id="fr_total" class="form-control col-md-7 col-xs-12 numbers" name="fr_total" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="fr_request">Fund Request <span class="required">*</span></label>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                          <input id="fr_request" class="form-control col-md-7 col-xs-12 numbers" name="fr_request" required="required" type="text">
                        </div>
                      </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $('#fr_total').number( true, 2 );
        $('#fr_request').number( true, 2 );
      });
    </script>
